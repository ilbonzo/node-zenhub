...
ReleaseReports.prototype.createReleaseReport = function (repoId, payload, callback) {
    this._http._post('repositories/' + repoId + '/reports/release', {}, payload, function(error, body) {
        callback(error, body);
    });
};
...
ReleaseReports.prototype.getReleaseReportsForRepository = function (repoId, callback) {
    this._http._get('repositories/' + repoId + '/reports/releases', {}, function(error, body) {
        callback(error, body);
    });
};
